...
func driveToParkedCall(t *testing.T, lf *liveFixture, me *Endpoints) (routeID, resID, agentID uuid.UUID) {
	t.Helper()
...
func TestReassign_DisconnectRequeues(t *testing.T) {
	...
	routeID, resID, agentID := driveToParkedCall(t, lf, me)
...
func TestReassign_ExhaustedAbandons(t *testing.T) {
	...
	me := newMatcherEndpoints(lf)
	routeID, resID, _ := driveToParkedCall(t, lf, me)
