...
| Date | Planning phase | OpenSpec destination |
| --- | --- | --- |
| 2026-05-15 | `01-foundation-polyglot-monorepo` | `openspec/specs/delivery-foundation/spec.md` |
| 2026-05-16 | `02-openapi-contract-codegen` | `openspec/specs/delivery-foundation/spec.md` |
| 2026-05-16 | `03-catalog-crud-go` | `openspec/specs/catalog-management/spec.md` |
| 2026-05-17 | `04-agent-state-machine-go` | `openspec/specs/agent-state/spec.md` |
| 2026-05-17 | `04.1-catalog-identity-normalization` | `openspec/specs/catalog-management/spec.md` |
