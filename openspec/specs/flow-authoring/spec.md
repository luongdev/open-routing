...
This specification captures v0.2 flow authoring: draft CRUD with optimistic versioning, graph validation, compile-to-plan over the node registry, publish/rollback governance, and flow entry bindings.
